...
class MyFirebase():
    API_KEY = "AIzaSyB__3ASDC_goxWdqPnPkjGp4VycA__bAGA"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get(f"https://appteste-557e1-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={id_token}")
            id_vendedor = req_id.json()

            link = f"https://appteste-557e1-default-rtdb.firebaseio.com/{local_id}.json?auth={id_token}"
            ...
            requests.patch(f"https://appteste-557e1-default-rtdb.firebaseio.com/.json?auth={id_token}", data=info_id_vendedor)
